...
# XXD Panel 170｜رسم صغير بخامات جافة بالأسود والأحمر الصدئ
...
هذه ثماني نتائج أولية لـ Panel 170، وُلّدت كل منها بشكل مستقل من صورة مصدر مختلفة، بنصوص إنجليزية قصيرة. الأفقي 1536×864 بنصفين متساويين يمينًا ويسارًا، والعمودي 1152×1536 بنصفين متساويين أعلى وأسفل.

رُوجعت مطابقة المصدر وآثار الوسائط الجافة بالأسود والأحمر الصدئي والورق لكل صورة. بعض العناصر أو النصوص كبيرة؛ التفاصيل زائدة في 05 و06، والمشاهد واسعة في 09 و12، وأضيفت شمس حمراء في 10، ويبرز الأحمر في 11. لم تتحقق شروط الرسم الصغير المعزول والتفاصيل القليلة والفراغ الواسع باستمرار. هذه نتائج أولية فعلية وليست مجموعة اجتازت التقييم الأسلوبي بالكامل.
...
أشكال صغيرة بضربات جافة كبيرة، يسودها الأسود الفحمي مع لمسات أحمر صدئ فقط، بلا ألواح خلفية أو تعدد ألوان.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 170 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-170`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-170 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-170-prompt.en.md) أو [بالصينية](references/xxd-panel-170-prompt.zh-CN.md).
